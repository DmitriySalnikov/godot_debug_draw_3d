...
title win x64
scons platform=windows target=template_release arch=x86_64 %api%
...
scons platform=android target=template_debug arch=arm64 %api%
...
scons platform=android target=template_release arch=arm64 %api%
