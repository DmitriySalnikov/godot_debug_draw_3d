...
#pragma region Text
	...
	NAPI void begin_text_group_c(const char *group_title_string, int group_priority = 0, godot::Color group_color = Colors::white_smoke, bool show_title = true, int title_size = -1, int text_size = -1);
