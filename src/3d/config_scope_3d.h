...
public:
	...
	/// @private
	NAPI NSELF_RETURN set_transform_selfreturn(Transform3D _value) const;
	NAPI Transform3D get_transform() const;
	...
	/// @private
	NAPI NSELF_RETURN set_text_outline_color_selfreturn(Color _value) const;
	NAPI Color get_text_outline_color() const;
	...
	/// @private
	NAPI NSELF_RETURN set_text_font_selfreturn(Ref<Font> _value) const;
	Ref<Font> get_text_font() const; // TODO:
