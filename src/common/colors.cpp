...
const Color Colors::plane_light_sky_blue = Color(0.529412f, 0.807843f, 0.980392f, 0.4f);
...
const Color Colors::dodger_blue = Color(0.12f, 0.56f, 1, 1);
...
const Color Colors::light_gray = Color(0.827451f, 0.827451f, 0.827451f, 1);
